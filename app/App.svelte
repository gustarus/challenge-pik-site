<script>
  ...
  import LogoutAuthPage from './pages/auth/LogoutAuthPage';
  import PropertyIndexPage from './pages/property/PropertyIndexPage.svelte';
  import PropertyCreatePage from './pages/property/PropertyCreatePage.svelte';
